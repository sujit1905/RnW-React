    ...
    <div className="flex min-h-[80vh] flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-50/50">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-500 font-medium">
          ...
          <Link to="/register" className="font-semibold leading-6 text-gray-900 hover:text-gray-600 transition-colors">
            Create one today
          </Link>
        </p>
      </div>
          ...
          <form className="space-y-8" action="#" method="POST">
            ...
            <div className="flex items-center justify-between pt-2">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-3 block text-sm leading-6 text-gray-700 font-medium cursor-pointer">
                  Remember me
                </label>
              </div>
          ...
          <div className="mt-10">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm font-medium leading-6">
                <span className="bg-white px-6 text-gray-500 tracking-wider">OR CONTINUE WITH</span>
              </div>
            </div>
            ...
            <div className="mt-6 flex space-x-4">
              <a
                href="#"
                className="flex w-full items-center justify-center gap-3 rounded-xl bg-white px-3 py-3.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 transition-colors focus-visible:ring-transparent"
              >
              ...
              <a
                href="#"
                className="flex w-full items-center justify-center gap-3 rounded-xl bg-[#24292F] px-3 py-3.5 text-sm font-semibold text-white shadow-sm hover:bg-[#24292F]/90 transition-colors focus-visible:ring-transparent"
              >
