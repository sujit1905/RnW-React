    ...
    <div className="bg-white/50 min-h-screen py-16 md:py-24">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 tracking-tight mb-4 text-center">
          Craft Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-400 to-gray-800">Masterpiece</span>
        </h1>
        <p className="text-center md:text-lg text-gray-500 mb-16 max-w-xl mx-auto font-medium">
          Have an idea? Turn it into reality. Fill out the details below and share your mind with the world.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-10 group">
          ...
          <div className="flex items-center justify-end gap-x-6 px-4">
            <button type="button" className="text-sm font-bold leading-6 text-gray-500 hover:text-gray-900 transition-colors uppercase tracking-wider">
              Cancel
            </button>
            <button
              type="submit"
